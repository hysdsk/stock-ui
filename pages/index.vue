      ...
      <el-tabs>
        <el-tab-pane label="出来高増加銘柄">
          ...
          <el-table :data="data.increaseVolumeSymbols" @row-click="moveTo">
            ...
            <el-table-column prop="averageVolume"   label="過去出来高" width="120" :formatter="formatNum"  align="right" sortable/>
        ...
        <el-tab-pane label="仕手上げ期待銘柄">
          ...
          <el-table :data="data.lowRankSymbols" @row-click="moveTo">
            ...
            <el-table-column prop="divisionName"    label="市場"       width="80" :formatter="formatDivision" sortable/>
            <el-table-column prop="bisCategoryName" label="業種名"     width="180" sortable/>
            <el-table-column prop="closingPrice"    label="直近終値"   width="120" :formatter="formatNum" align="right" sortable/>
            <el-table-column prop="averageVolume"   label="平均出来高" width="120" :formatter="formatNum" align="right" sortable/>
            <el-table-column prop="marketPrice"     label="時価総額"   width="160" :formatter="formatNum" align="right" sortable/>
          </el-table>
        </el-tab-pane>
      </el-tabs>
    </el-main>
